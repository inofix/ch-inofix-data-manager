...
import ch.inofix.data.background.task.BackgroundTaskExecutorConfigurator;
...
public class BackgroundTaskExecutorConfigurator {
   ...
   protected void activate(BundleContext bundleContext) {
       BackgroundTaskExecutor taskRecordExportBackgroundTaskExecutor = new MeasurementExportBackgroundTaskExecutor();

       registerBackgroundTaskExecutor(bundleContext, taskRecordExportBackgroundTaskExecutor);

       BackgroundTaskExecutor taskRecordImportBackgroundTaskExecutor = new MeasurementImportBackgroundTaskExecutor();
