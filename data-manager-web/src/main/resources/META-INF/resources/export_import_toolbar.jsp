<%--
    ...
    Modified:   2017-11-19 22:37 by Christian Berndt
    Version:    1.0.2
--%>
...
<%
    ...
    String taskExecutorName = MeasurementExportBackgroundTaskExecutor.class.getName(); 
    
    if ("import".equals(tabs2)) {
        taskExecutorName = MeasurementImportBackgroundTaskExecutor.class.getName();         
    }
