        ...
        function(event) {
            ...
            exportImportOptions.plug(
                A.Plugin.IO,
                {
                    ...
                    <liferay-portlet:resourceURL copyCurrentRenderParameters="<%= false %>" id="importMeasurements" var="importMeasurementsURL">
